...
const heroapi = {
  title: "Juega con las Nike eléctricas",
  subtitle: "Zapatillas Adapt 2.0",
  img: heroimg,
...
const highlight = {
  heading: "DESTACAR",
  title: "NIKE AIR ILIMITADAS",
  text: "Nuestro propósito es hacer que el mundo avance. Tomamos medidas construyendo comunidad, protegiendo nuestro planeta y aumentando el acceso al deporte.",
  btn: "Explorar Más",
...
const sneaker = {
  heading: "DESTACADAS",
  title: "ZAPATILLAS NIKE CON PUNCIÓN DE AIRE",
  text: "El resplandor vive en Nike Sneakers Air Lancing Shoes, el baloncesto OG OG que le da un nuevo giro a lo que mejor conoces: superposiciones cosidas duraderas, acabados limpios y la cantidad perfecta de destello para hacerte brillar.",
  btn: "Explorar Más",
